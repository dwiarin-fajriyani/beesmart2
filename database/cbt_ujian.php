...
$backup_file = 'backup/dbee-ujian_'.time().'.sql';
// get backup
//$mybackup = backup_tables("localhost:3306","root","","beesmartv3","*");
$mybackup = backup_tables($host,$username,$passdb,$namedb,$tabel);
...
<br /><div class="alert alert-success alert-dismissable" >
                                ...
                                Tabel <?php echo $tabel; ?> telah di Backup<br /><br>
								<a href="<?php echo $backup_file; ?>" target="_blank">
								<button type="button" class="btn btn-warning btn-small"><i class="fa fa-cloud-upload"></i> Download</button></a>
                            </div>
