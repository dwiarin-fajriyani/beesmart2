...
<html class="no-js" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>CBT SMKN 2 SUMEDANG | COMPUTER BASED TEST</title>
	<script language="JavaScript">
	var txt="SMKN 2 SUMEDANG | COMPUTER BASED TEST......";
...
<div class="group">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href=""><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-left:0px;"></a></div>
...
<div  class="col-md-4 col-md-offset-4 login-wrapper" id="panel_login" style="float:inherit; margin-top:0px; min-width:15%;  max-width:500px;">
