...
$xtgl1 = "$xtgl1 $xjam1";
	...
	(XNomerUjian, XKodeKelas, XKodeMapel,XKodeSoal,XJumSoal,XTglUjian,XJamUjian, XMulaiUjian, XLastUpdate, XSisaWaktu, XLamaUjian,XTokenUjian,XStatusUjian,XSesi,XPilGanda,XEsai,XGetIP) values 
	('$user','$xkodekelasx','$xkodemapel','$xkodesoal','$xjumlahsoal','$xtgl1','$xjamujian','$xjam1',
	'$xjam1','$xlamaujian','$xlamaujian','$xtokenujian','1','$xsesi','$xjumpilg','$xjumesai','$user_ip')"); 
...
<div class="group">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="http://tuwagapat.com"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-left:0px;"></a>
    	...
    	<div class="right1"><table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">   
                        ...
                        <tr><td><span class="user"><?php echo "$val_siswa ($s[XNomerUjian])"; ?></span></td></tr>
