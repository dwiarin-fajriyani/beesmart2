...
<html class="no-js" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	var txt="CBT BEESMART | UJIAN ONLINE......";
...
<div class="group">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="http://tuwagapat.com"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-left:0px;"></a>
    	...
    	<div class="right"><table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">   
                        ...
                        <tr><td><span class="user"><?php echo "$val_siswa ($sis[XNomerUjian])"; ?></span></td></tr>
...
<form action="mulai.php" method="post">    
                ...
                <div class="list-group-item">
                    <label class="list-group-item-heading">Nomor Ujian</label>
...
?>
<?php
 $sqlcekujian = mysql_num_rows(mysql_query("SELECT * FROM cbt_ujian where(XKodeKelas = '$xkelz' or XKodeKelas = 'ALL') and (XKodeJurusan = '$xjurz' or XKodeJurusan = 'ALL') and XStatusUjian = '1' 
 and XSesi =  '$xsesi' and XLevel =  '$xlevel'"));
// echo "jurusan :". $xjurz;
// echo "sesi :". $xsesi;
// echo "xkodekelas :". $xkelz;
// echo "level :". $xlevel;


// $sqlcekujian = mysql_num_rows(mysql_query("SELECT * FROM cbt_ujian where(XKodeKelas = '0001' or XKodeKelas = 'ALL') and (XKodeJurusan = 'RPL' or XKodeJurusan = 'ALL') and XStatusUjian = '1' 
//  and XSesi =  '1' and XLevel =  'XII'"));
if($sqlcekujian>0){ ?>
...
<div style="margin-top:160px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
    <div class="content">
        CBT.BeeSMART.Web:<strong>3.0</strong><br>
